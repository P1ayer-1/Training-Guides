...
accelerate launch --main_process_port 32183 --main_process_ip "$MASTER_ADDR" --machine_rank "$SLURM_PROCID"  --num_processes $((4 * SLURM_JOB_NUM_NODES)) --num_machines $SLURM_JOB_NUM_NODES --config_file /pfs/lustrep4/scratch/project_462000259/training_templates/accelerate_conf.yaml /pfs/lustrep4/scratch/project_462000259/mdel_builds/MDEL/src/mdel/trainer.py \
        --configs lumi   \
